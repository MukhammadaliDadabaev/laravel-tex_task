          ...
          <div class='flex items-center justify-center py-3'>
            <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
              ...
              <div class="flex justify-between">
                ...
                <div>
                  <div class="flex flex-col text-center border rounded-xl m-5 p-5 hover:bg-gray-100 transition duration-300">
                  ...
                  <div class="mt-10">
                    <a href="{{ route('answers.create', ['application' => $application->id]) }}" type="button" class="text-sm each-in-out bg-green-500 text-white rounded mx-6 p-2 hover:bg-green-600 transition duration-300">
                      ANSWER
                    </a>
                  </div>
                </div>
